...
SECRET_KEY = 'django-insecure-9kxgl^^xzwbieq!n#2gqi_llhei%mog2x8v8)tpw$k!+edflm_'
...
ROOT_URLCONF = 'industriawayne.urls'
...
WSGI_APPLICATION = 'industriawayne.wsgi.application'
...
STATICFILES_DIRS = (
    MEDIA_ROOT,
    # os.path.join(BASE_DIR, 'gerenciador_industriawayne\\templates\media\images'),
)
